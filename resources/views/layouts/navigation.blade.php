<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <!-- Cart Icon -->
                <a href="{{ route('cart.index') }}" class="relative me-4 text-gray-500 hover:text-gray-700 transition duration-150 ease-in-out">
                        ...
                        <x-slot name="content">
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <x-dropdown-link :href="route('logout')"
                                    ...
                                    {{ auth()->user()->role === 'admin' ? __('Logout Admin') : __('Log Out') }}
                                </x-dropdown-link>
                            </form>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                <x-responsive-nav-link :href="route('recommendation.index')" :active="request()->routeIs('recommendation.index')">
                    {{ __('Rekomendasi') }}
